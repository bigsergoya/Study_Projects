...
namespace VisualChart3D.Common.PictureMaster
{
    //Класс нигде не используется. Отличный пример говнокода. Исправлю. 
    class BaseImageMaster
    {
        bool Is_Picture;
        ...
        private void Paining(Image Picture, int SelectedIndex, Engine SettFile)
        {
